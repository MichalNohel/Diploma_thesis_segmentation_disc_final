...
%%
% Funkce, která modifikuje jas
% vstup:
% img,fov - image - obraz a fov
% sigma,Num_tiles_param,ClipLimit - int - parametry normalizace
% výstup:
% img_interp - image - normalizovaný obraz 
%%
S=strel('disk',1);
mask=imerode(fov,S);
