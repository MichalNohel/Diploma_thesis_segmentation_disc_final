# -*- coding: utf-8 -*-
"""
Created on Mon Apr  3 12:54:08 2023
...
def convert(source_folder, target_dataset_name):
    ...
    source_folder
    """
    nnUNet_raw="E:/Transfer_to_CUDA/nnUNet_raw"
...
if __name__ == "__main__": 
    convert('E:/Transfer_to_CUDA/nnUNet_raw/Task725_Optic_disc_cup_segm_25px', 'Dataset725_Optic_disc_cup_segm_25px')
